...
export const Values: ValuesByVersion = {
  ...
  '1.21.4': {
    tags: {
      'worldgen/biome': '1.21.4/tags/worldgen/biome.json',
      'worldgen/flat_level_generator_preset':
        '1.19.3/tags/worldgen/flat_level_generator_preset.json',
      'worldgen/structure': '1.21.4/tags/worldgen/structure.json',
      'worldgen/world_preset': '1.19.3/tags/worldgen/world_preset.json'
    },
    registries: {
      'entity_type': registryUrl('1.21.4', 'entity_type'),
      'particle_type': registryUrl('1.21.4', 'particle_type'),
      'sound_event': registryUrl('1.21.4', 'sound_event'),
      'worldgen/biome': '1.21.4/worldgen/biome.json',
      'worldgen/configured_carver': '1.19.3/worldgen/configured_carver.json',
      'worldgen/configured_feature': '1.21.4/worldgen/configured_feature.json',
      'worldgen/density_function': '1.19.3/worldgen/density_function.json',
      'worldgen/flat_level_generator_preset':
        '1.19.3/worldgen/flat_level_generator_preset.json',
      'worldgen/noise': '1.19.3/worldgen/noise.json',
      'worldgen/noise_settings': '1.19.3/worldgen/noise_settings.json',
      'worldgen/placed_feature': '1.21.4/worldgen/placed_feature.json',
      'worldgen/processor_list': '1.21.4/worldgen/processor_list.json',
      'worldgen/structure': '1.21.4/worldgen/structure.json',
      'worldgen/structure_set': '1.21.4/worldgen/structure_set.json',
      'worldgen/template_pool': '1.21.4/worldgen/template_pool.json',
      'worldgen/world_preset': '1.19.3/worldgen/world_preset.json'
    }
  }
};
