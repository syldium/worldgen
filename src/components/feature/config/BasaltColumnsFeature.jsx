...
export function BasaltColumnsFeature({ configuration, onChange }) {
    ...
    return <fieldset>
        ...
        <div className="form-group form-row">
            <UniformInt id="reach" value={configuration.reach} maxBase={2} maxSpread={2} upChange={handleReachChange}>Reach</UniformInt>
            <UniformInt id="height" value={configuration.height} minBase={1} maxBase={5} maxSpread={5} upChange={handleHeightChange}>Height</UniformInt>
        </div>
    </fieldset>
}
