...
for (
  ...
  const html = template
    .replace(
      '<!--meta-->',
      `<meta name="description" content="A ${custom}${name} datapack generator for Minecraft Java Edition 1.19-1.21.4" />
    <meta property="og:title" content="${capitalizedName} datapack generator for Minecraft" />
    <meta property="og:description" content="A tool to generate datapacks with ${custom}${plural} for Minecraft 1.19-1.21.4" />${canonical}`
    )
